    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 p-4 md:p-6">
      ...
      <div className="mt-4 flex gap-2 pt-4 border-t border-gray-100">
        <Link
          ...
          className="flex-1 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-center text-sm font-semibold text-emerald-700 transition hover:bg-emerald-500/15"
        >
          View match
        </Link>
        <button
          ...
          disabled={isAdding}
          className="rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition hover:border-emerald-500/40 hover:text-emerald-700 disabled:cursor-not-allowed disabled:opacity-60"
        >
